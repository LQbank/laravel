    		...
    		<div class="mws-form-inline">
    			<div class="mws-form-row">
    				...
    				<div class="mws-form-item">
    					<input type="text" disabled name="name" value="{{ $user->name }}" class="small">
    				</div>
    			</div>
                ...
                <img src="/uploads/{{ $user->avatar }}" style="border:1px solid #ccc;border-radius: 10%;width: 110px;">

    			<div class="mws-form-row" style="width: 610px;">
    				<label class="mws-form-label">头像</label>
    				<div class="mws-form-item">
    					<input type="file" name="avatar" value="" class="small">
    				</div>
    			</div>
