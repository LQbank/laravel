...
<div class="am-container header">
  ...
  <ul class="message-r">
    ...
    <div class="topMessage my-shangcheng"><div class="menu-hd MyShangcheng"><a href="/home/center" target="_top"><i class="am-icon-user am-icon-fw"></i>个人中心</a></div></div>
    ...
    <div class="topMessage favorite"><div class="menu-hd"><a href="/home/collection" target="_top"><i class="am-icon-heart am-icon-fw"></i><span>收藏夹</span></a></div>
  </ul>
</div>
   ...
   <div class="successInfo">
     <ul>
       ...
       <div class="user-info">
         ...
         <p>收货地址：{{ $address->province }}省 {{ $address->city }} {{ $address->district }} {{ $address->address }}</p>
       </div>
